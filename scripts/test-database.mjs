...
const files = ["supabase/tests/bootstrap.sql", ...readdirSync("supabase/migrations").filter((f) => f.endsWith(".sql")).sort().map((f) => `supabase/migrations/${f}`), "supabase/tests/security.sql", "supabase/tests/admin.sql"];
